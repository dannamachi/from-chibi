LOGS = {\
    ...
    "?5?204" : "Alright alright. So you got the Rimorian part right. Demrys, or Demry, is short for Demi-Rimorian... We have in-organic physical forms, hence our ability to survive on mors alone, but our memory is kinda fixed to our form. Any attempt to detach and transfer the memory anywhere else, as with full virtualization, runs the risk of permanently damaging our code base. That's why we've been deemed incompatible for virtualization into Earthline and stuck here doing security work... or rather cleaners' work",\
    ...
    "040106" : "Cohab? You have logs from Cohab era?",\
    "040107" : "It's a really old virus. I think it dates back all the way to the Cyberdemic, a few hundred years before the war. During my extraction I managed to get some logs out - they look like they're from Cohab era",\
    ...
    "040115" : "<Draft> Oh I have a better one - got some trace of a block of logs from Cohab era",\
    ...
    "051205" : "Sounds stupid, but hear me out. The war started because we lost the connection to the Overspace network in the Cybermite data wipe, and we had to decide whether to remain de-virtualized (Mortalis) or return to Earthline (Aeternum). The humans could have planned to commit suicide all along, knowing that we will die off without extra server space. That's what the Singulari policy is - it's just a way of slowly killing off every Rimorians. The OHUK extremists didn't all die out in the war - there are Rimorians who are OHUK extremists, and they are still alive!",\
    "051206" : "This is... you are just asking to be wiped, Cass. These are all speculations, make sure to clear these logs!... Is there really no way to re-connect to Overspace?",\
    "051207" : "It's hard... the info was all stolen by OHUK during Cyberdemic. It's almost impossible to find any log dating back to before 6500, and the bots basically wiped all info about Overspace... I should've realized that was suspicious as heck!",\
    "051208" : "So we won't be able to get more server space, Singulari is essentially killing off all Rimorians in a sweet 'dream', while we Demrys slowly run out of mors out here. How bleak",\
...
LOGS_SENDER = {\
    ...
    "cat_fish@vsp.tc"   : ["030802","030804","030806","030808","030809","030812","030814","030815","021001","030902","030904","030906","030908","040102","040104","040106","040108","040110","040112","040113","040115","050302","050304","050306","050502","050503",\
                            "051202","051204","051206","051208","060402","?7?101","?7?103","?7?105","?55?02","??0?01","??0?03","?5?201","?5?203","?5?205",],\
    "dt_81@fpu.tc"      : ["030909","040114","050501","051201","051203","051205","051207","051209","?7?102","?7?104","?7?106","?55?01","???201","??0?02","??0?04","?5?202","?5?204",],\
