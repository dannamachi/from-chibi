KEYMAP = {\
    ...
    "3-layer-soccer.bpt"      : "677273667383857569",\
    "thank-you.bpt"           : "677273667383857569",\
    "debris-full-sky.bpt"     : "677273667383857569",\
    "cat_playing_soccer.bpt"  : "677273667383857569",\
}
...
RESULTS = {\
    ...
    "last_piece.bpt" : "ping 266694:990002:: ping 9933:12:45900:009:: ping 11111:111:1111:1::",\
    ...
    "debris-full-sky.bpt"     : "Log ?????3 by SUKE: LUCA, I knew that you couldn't possibly just left things like that. The diagrams left in these bpaints were for the creation of a virus. A self-replicating virus that can pass parts of its code as log attachments to other AI-based creatures. After the target has saved all files, essentially having a copy of the virus, the original can perform the function it was intended to do - in this case, contacting overspace. And if it fails to do so then it will recompile itself into a rootkit-like program to avoid analysis (most bots tend to just erase it). The persona code saved at the target terminal will wipe the memory database and instruct the wiped AI to assemble the self-replicating code (in the form of fake incoming logs) before repeating the process again",\
